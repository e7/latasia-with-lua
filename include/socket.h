...
extern lts_pool_t *lts_sockcache_pool; // socket缓存专用内存池
extern dlist_t lts_sock_list; // socket缓存列表
extern size_t lts_sockcache_n; // socket缓存余量
...
// 创建socket缓存
extern void lts_create_sockcache(size_t nconns);
// 销毁socket缓存
extern void lts_destroy_sockcache(void);
